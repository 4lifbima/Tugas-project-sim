	  ...
	  <!-- <div id="carouselExample" class="carousel slide" data-bs-ride="carousel"> 
		<div class="carousel-inner">
			<div class="carousel-item active position-relative">
				<img src="./assets/img/bg/slider.jpeg" class="d-block w-100 h-100 object-fit-cover" alt="Meeting 1">
				<div class="overlay position-absolute top-0 left-0 h-100 w-100 bg-dark" style="opacity: 0.85; mix-blend-mode: multiply; filter: contrast(1.15) brightness(0.85);" ></div>
				<div class="position-absolute top-50 start-50 translate-middle text-center">
					<h1 class="m-0 text-white tracking-tight text-4xl fw-bold" data-aos-delay="0" data-aos="fade" data-aos-duration="1000">Selamat Datang Di website kami</h1>
					<p class="m-0 mt-4 text-white text-lg leading-8" data-aos-delay="100" data-aos="fade" data-aos-duration="3000">SMA Negeri 6 Gorontalo, sebuah lembaga pendidikan menengah atas negeri yang berlokasi di Jalan Barito, Kelurahan Bulotadaa Timur, Kecamatan Sipatana, Kota Gorontalo, Provinsi Gorontalo.</p>
				</div>
			</div>
			<div class="carousel-item position-relative">
				<img src="./assets/img/bg/slider.jpeg" class="d-block w-100 h-100 object-fit-cover" alt="Meeting 2">
				<div class="overlay position-absolute top-0 left-0 h-100 w-100 bg-dark" style="opacity: 0.85;"></div>
				<div class="position-absolute top-50 start-50 translate-middle text-center">
					<h1 class="m-0 text-white tracking-tight text-4xl fw-bold" data-aos-delay="0" data-aos="fade" data-aos-duration="1000">Selamat Datang Di website kami</h1>
					<p class="m-0 mt-4 text-white text-lg leading-8" data-aos-delay="100" data-aos="fade" data-aos-duration="3000">SMA Negeri 6 Gorontalo, sebuah lembaga pendidikan menengah atas negeri yang berlokasi di Jalan Barito, Kelurahan Bulotadaa Timur, Kecamatan Sipatana, Kota Gorontalo, Provinsi Gorontalo.</p>
				</div>
			...
			<div class="carousel-item position-relative">
				<img src="./assets/img/bg/bg2.jpg" class="d-block w-100 h-100 object-fit-cover" alt="Meeting 3">
				<div class="overlay position-absolute top-0 left-0 h-100 w-100 bg-dark" style="opacity: 0.85;"></div>
				<div class="position-absolute top-50 start-50 translate-middle text-center">
					<h1 class="m-0 text-white tracking-tight text-4xl fw-bold" data-aos-delay="0" data-aos="fade" data-aos-duration="1000">Selamat Datang Di website kami</h1>
					<p class="m-0 mt-4 text-white text-lg leading-8" data-aos-delay="100" data-aos="fade" data-aos-duration="3000">SMA Negeri 6 Gorontalo, sebuah lembaga pendidikan menengah atas negeri yang berlokasi di Jalan Barito, Kelurahan Bulotadaa Timur, Kecamatan Sipatana, Kota Gorontalo, Provinsi Gorontalo.</p>
				...
				<div class="col-12 col-xl-5">
					<div class="mx-auto max-w-2xl">
						...
						<p class="m-0 mt-4 text-body-secondary text-lg leading-8">
							Lorem ipsum dolor sit amet consectetur adipisicing elit. Optio voluptate iste modi dignissimos nostrum atque illum perferendis, natus quod, odio quae facilis. Omnis quidem repudiandae consequuntur similique eos suscipit voluptatem dolorum voluptates eum distinctio, vero voluptatum nam non molestias! Sit obcaecati nostrum qui maxime laborum veritatis quae! Veniam, obcaecati possimus.
						</p>
					</div>
				</div>
