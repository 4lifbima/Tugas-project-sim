...
<body>
	...
	<!-- header top -->
	<header class="navigation position-absolute w-100 shadow border-bottom border-light border-opacity-10" style="background-color: #0d1750;">
	    <nav class="navbar navbar-expand-xl" aria-label="Offcanvas navbar large">
	        <div class="container py-1">
	            <a href="./index.html" class="navbar-brand">
	                <img src="./assets/logo/logo-sman6.png" height="50" alt="logo">
	            </a>
	                ...
	                <div class="offcanvas-header" style="padding: 2rem 2rem 1.5rem 2rem;">
	                    <h5 class="offcanvas-title m-0" id="offcanvasNavbar2Label">
	                        <a class="navbar-brand" href="javascript:;">
	                            <img src="./assets/logo/logo-sman6.png" height="32" alt="logo">
	                        </a>
	                    </h5>
	                ...
	                <div class="offcanvas-body">
	                    <ul class="navbar-nav align-items-xl-center flex-grow-1 column-gap-4 row-gap-4 row-gap-xl-2">
	                        <li class="nav-item ms-xl-auto">
	                            <a href="./index.php" class="px-3 text-sm-secondary bg-body-secondary-hover nav-link rounded-3 text-base leading-6 fw-semibold" style="color: #bbbaba;" aria-current="page">
	                                Beranda
	                            </a>
	                        </li>

							<li class="nav-item">
	                            <a href="./services.php" class="px-3 bg-body-secondary-hover nav-link rounded-3 text-base leading-6 fw-semibold" style="color: #bbbaba;">
	                                Tentang
	                            </a>
	                        </li>

							<li class="nav-item">
	                            <a href="./services.html" class="px-3 bg-body-secondary-hover nav-link rounded-3 text-base leading-6 fw-semibold" style="color: #bbbaba;">
	                                Sejarah
	                            </a>
	                        </li>
	                        ...
	                        <li class="nav-item">
	                            <a href="./about.html" class="px-3 bg-body-secondary-hover nav-link rounded-3 text-base leading-6 fw-semibold" style="color: #bbbaba;">
	                                Gallery
	                            </a>
	                        </li>
	                        ...
	                        <li class="nav-item">
					            <div class="dropdown">
								    <button class="btn w-100 text-start dropdown-toggle px-3 nav-link rounded-3 text-base leading-6 fw-semibold" type="button" data-bs-toggle="dropdown" aria-expanded="false" style="color: #bbbaba;">
								        Informasi
								    </button>
